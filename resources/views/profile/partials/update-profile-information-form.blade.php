<section class="mt-8">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <form method="post" action="{{ route('profile.photo', ['user' => $user->id]) }}" class="mt-6 space-y-6"
            ...
            <div class="flex items-center space-x-4 mb-6">
                ...
                <img src="{{ $user->getFirstMediaUrl('avatar') ?: asset('img/default-profile.png') }}"
                    alt="Foto de perfil" class="rounded-full w-20 h-20">
                <div>
        ...
        <!-- Borrar la foto de perfil actual -->

        <form method="POST" action="{{ route('profile.photo-delete', ['user' => $user->id]) }}">
            @csrf
            @method('DELETE')
            <div class="mt-2">
                <x-primary-button>
