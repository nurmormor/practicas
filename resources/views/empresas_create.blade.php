<x-app-layout>
    <div class="container mx-auto p-6 max-w-lg">
        <h1 class="text-3xl font-bold text-gray-800 text-center mb-8">Añadir Empresa</h1>

        <form action="{{ route('empresas_store') }}" method="POST" class="space-y-6 bg-white p-8 rounded-xl shadow-lg">
            @csrf
            <h1 class="text-3xl font-bold text-gray-800 text-center mb-8">Añadir Empresa</h1>
            <div>
